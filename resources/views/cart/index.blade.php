...
<script>
    $(document).ready(function(){
        ...
        $('.btn-remove').click(function(){
            ...
            // closest()可以获取到匹配选择器的第一个祖先元素，在这里就是当前点击的移除按钮之上的
            // data('id')方法可以获取到我们之前设置的data-id的属性的值，也就是对应的sku-id
        ...
        $('#select-all').change(function(){
            // 获取单选框的选中状态
            // prop方法可以知道标签中是包含某个属性，当单选框被勾选时，对应的标签就会新增一个checked
            var checked=$(this).prop('checked');
            // 获取所有 name=select 并且不带有disabled属性的勾选框
        ...
        $('.btn-create-order').click(function(){
            ...
            // 遍历<table>标签内所有带data-id属性的tr标签，也就是每一个购物车中的商品sku
